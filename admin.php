...
<head>
    ...
    <link rel="stylesheet" href="admin.css?v=1.7.0">
</head>
...
<body>
        ...
        <main class="main-content">
            ...
            <section class="content-section hidden" id="mediaSection">
                ...
                <div class="media-filter-bar">
                    ...
                    <button class="btn btn-primary btn-download-all" id="downloadAllMedia" onclick="downloadAllMedia()">
    ...
    <script src="admin.js?v=1.7.0"></script>
</body>
